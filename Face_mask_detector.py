...
class VideoCamera(object):
	...
	def detect_and_predict_mask(self,frame, face_detection_model, mask_detection_model):
		(h, w) = frame.shape[:2]
	...
	def get_frame(self):
		...
		(locs, preds) = self.detect_and_predict_mask(frame, face_detection_model, mask_detection_model)
